...
Renderer::Renderer(size_t size_x, size_t size_y, const char* window_name)
{
    ...
    if (display_ == nullptr)
    {
        throw std::runtime_error("Renderer(): unable to create display object");
    }
    ...
    if (ret == false)
    {
        throw std::runtime_error("Renderer(): XDBE X11 extension is reqired and missing");
    }
...
//==================================================================================================
// Функция: Renderer::draw_rect
// Назначение: Отрисовывает прямоугольник на экране.
//==================================================================================================
...
//==================================================================================================
// Функция: Renderer::draw_circle
// Назначение: Отрисовывает круг на экране.
//==================================================================================================
